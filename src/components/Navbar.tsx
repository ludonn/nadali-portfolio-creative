...
const Navbar = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'blur-header py-3' : 'py-5'}`}>
      <div className="container flex justify-between items-center">
        ...
        >
          ...
          <span className="absolute top-0 left-0 transition-transform duration-500 ease-out text-gradient" style={{
